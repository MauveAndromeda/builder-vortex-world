...
export default function GlobalSkyLayer() {
  ...
  const [autoMode, setAutoMode] = useState<Mode>(() =>
    resolveModeByHour(new Date().getHours()),
  );
  useEffect(() => {
    const id = setInterval(
      () => setAutoMode(resolveModeByHour(new Date().getHours())),
      60 * 1000,
    );
  ...
  return (
    ...
    >
          ...
          {Array.from({ length: cloudCount }).map((_, i) => (
            <div
              ...
              style={{
                ...
                filter: "blur(0.5px)",
                animation:
                  `cloud-move ${70 + (i % 4) * 15}s linear ${i * 4}s infinite` as any,
                background:
        ...
        <>
          ...
          >
            <g
              style={{
                opacity: 0.25,
                animation: "plane 45s linear infinite" as any,
              }}
            >
            ...
            {Array.from({ length: 4 }).map((_, i) => (
              <g
                ...
                style={{
                  opacity: 0.22,
                  animation:
                    `birds ${38 + (i % 3) * 8}s linear ${i * 5}s infinite` as any,
                }}
              >
                <g
                  transform={`translate(-10, ${18 + i * 18}) scale(${0.8 + (i % 3) * 0.25})`}
                >
                  <path
                    d="M0 0 C 3 -3, 6 -3, 9 0 M9 0 C 12 -3, 15 -3, 18 0"
                    fill="none"
                    stroke="#ffffff"
                    strokeWidth="0.8"
                    strokeLinecap="round"
                  />
                  <path
                    d="M22 2 C 25 -1, 28 -1, 31 2 M31 2 C 34 -1, 37 -1, 40 2"
                    fill="none"
                    stroke="#ffffff"
                    strokeWidth="0.7"
                    strokeLinecap="round"
                  />
                  <path
                    d="M44 -1 C 47 -4, 50 -4, 53 -1 M53 -1 C 56 -4, 59 -4, 62 -1"
                    fill="none"
                    stroke="#ffffff"
                    strokeWidth="0.7"
                    strokeLinecap="round"
      ...
      {isGolden && (
        <div className="absolute inset-0">
          ...
          >
            ...
            <path
              d="M0 20 L0 12 L4 12 L4 9 L7 9 L7 14 L12 14 L12 10 L15 10 L15 16 L21 16 L21 7 L24 7 L24 15 L30 15 L30 11 L35 11 L35 18 L42 18 L42 9 L46 9 L46 17 L53 17 L53 12 L58 12 L58 19 L66 19 L66 10 L72 10 L72 16 L80 16 L80 12 L86 12 L86 18 L94 18 L94 13 L100 13 L100 20 Z"
              fill="url(#cityg)"
            />
          </svg>
          {/* whale */}
          ...
          >
            <g
              style={{
                opacity: 0.25,
                animation: "whale 6s ease-in-out infinite" as any,
              }}
            >
              <path
                d="M10 50 C40 20, 100 20, 150 40 C170 45, 185 50, 190 60 C170 52, 150 55, 130 60 C100 70, 60 70, 30 60 Z"
                fill="#ffffff"
              />
          ...
          {Array.from({ length: wc === "storm" ? 80 : 60 }).map((_, i) => (
            <div
              ...
              style={{
                ...
                animation:
                  `rain-fall ${wc === "storm" ? 0.8 + (i % 8) * 0.1 : 1 + (i % 10) * 0.12}s linear ${(i % 20) * 0.1}s infinite` as any,
              }}
            />
          ))}
            ...
            Array.from({ length: 15 }).map((_, i) => (
              <div
                ...
                style={{
                  ...
                  borderRadius: "50%",
                  animation:
                    `rain-splash ${2 + (i % 6) * 0.3}s ease-out ${(i % 12) * 0.2}s infinite` as any,
                }}
              />
            ))}
        </div>
      ...
      {(wc === "snow" || wc === "blizzard") && (
        <div className="absolute inset-0 overflow-hidden">
          ...
          {Array.from({ length: wc === "blizzard" ? 120 : 80 }).map((_, i) => {
            const size =
              wc === "blizzard" ? 2 + Math.random() * 4 : 3 + Math.random() * 3;
            return (
              <div
                key={`snow-${i}`}
                className="absolute"
            ...
            return (
              <div
                ...
                style={{
                  ...
                  borderRadius: 9999,
                  background:
                    "radial-gradient(circle at 30% 30%, rgba(255,255,255,1), rgba(200,220,255,0.9))",
                  boxShadow:
                    "0 0 4px rgba(255,255,255,0.8), inset 1px 1px 2px rgba(255,255,255,0.9)",
                  animation:
                    `hail-fall ${1.2 + (i % 8) * 0.15}s ease-in ${(i % 20) * 0.1}s infinite` as any,
                }}
              />
            );
          })}
          ...
          {Array.from({ length: 12 }).map((_, i) => (
            <div
              ...
              style={{
                ...
                animation:
                  `hail-bounce ${1.8 + (i % 6) * 0.3}s ease-out ${(i % 15) * 0.15}s infinite` as any,
              }}
            />
          ))}
        </div>
          ...
          {Array.from({ length: 18 }).map((_, i) => (
            <div
              ...
              style={{
                ...
                animation:
                  `wind-swish ${4 + (i % 5) * 1}s ease-in-out ${(i % 8) * 0.5}s infinite` as any,
              }}
            />
          ))}
          {/* Dust particles */}
          {Array.from({ length: 25 }).map((_, i) => (
            <div
              ...
              style={{
                ...
                opacity: 0.6,
                animation:
                  `wind-dust ${3 + (i % 6) * 0.8}s linear ${(i % 10) * 0.3}s infinite` as any,
              }}
            />
          ))}
        </div>
      ...
      {wc === "storm" && (
        <div
          className="absolute inset-0"
          style={{ animation: "lightning-flash 7s infinite" as any }}
        />
      )}

      <div
        className="absolute inset-0"
        style={{ backgroundColor: `rgba(0,0,0,${theme.overlay})` }}
      />
