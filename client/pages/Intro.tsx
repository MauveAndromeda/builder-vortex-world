  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="text-center px-6">
        ...
        <p className="mt-3 text-lg text-muted-foreground animate-in fade-in duration-700 delay-150">
          恭喜你发现了伊城的小书屋
        </p>
        <a
          onClick={skip}
          href={localized("/", locale)}
          className="mt-8 inline-block rounded-full border px-4 py-2 text-sm opacity-80 hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring"
        >
          Skip
        </a>
      </div>
